...
自助服务门户位于[https://console.{{siteDomain}}](https://console.{{siteDomain}}/cas/login?lang=zh) （以下统称为**“门户”**或**“产品门户”**）。
...
3.3     您对通过公司服务分发内容的合法性和适当性承担全部责任（无论您或您的最终用户的内容如何），并负责获得与内容相关的所有授权和权限。您承认，公司不承担与您的业务或您网站的任何操作相关的业务和/或运营风险；同时，如果公司自行决定认为任何内容或对服务的使用可能导致侵犯知识产权、适用法律或[使用政策](</docs/aup.md>)，则公司保留暂停使用服务或删除任何内容的权利，且无需事先通知您。
...
3.7     您同意并自愿使用公司提供的服务计费和数据查询系统。您对账单或数据（如有）的疑问或分歧不应成为您单方面终止/暂停服务和/或免除付款义务的理由。您有权收到公司的发票，并有义务在发票日期后14天内支付服务费。您根据本协议支付的所有款项均应全额支付，不得有任何抵销、限制或条件，也不得因任何索赔而扣减任何款项。如果公司在上述付款期内未收到款项，您的账户可能会被暂停和/或终止。
...
4.6     公司有权适时修改和调整产品的价格模型（详见 [https://www.{{siteDomain}}/cn/products/cdnpro-pricing/](https://www.{{siteDomain}}/cn/products/cdnpro-pricing)  ）。公司会在价格模型变更前提前45天通知现有客户。
...
6.6     您在此同意，根据SLA授予的服务Credit是公司未能提供服务的唯一补救措施。
