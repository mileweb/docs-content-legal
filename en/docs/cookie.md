...
A “cookie” is a small amount of data that is sent by the website’s server to your web browser and stored locally on your computer or mobile device. In general, cookies can be divided into the following categories:
...
This section explains the cookies used by CDN Pro. These cookies are essential for our websites to function and are usually set in response to your requests made to our servers, which cannot be switched off as our services cannot be provided without them.
...
If you have any questions, concerns or suggestions related to this Cookie Policy, please contact us via email at [abuse@{{siteDomain}}](mailto:abuse@{{siteDomain}})
